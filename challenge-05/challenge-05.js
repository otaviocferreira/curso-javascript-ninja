...
segundo parâmetro.
*/
function recebeArrayEIndice(array, indice) {
	return array[indice];
}
...
*/
var arrayDiferente = [null, 0, "string", true, NaN];

/*
Invoque a função criada acima, fazendo-a retornar todos os valores do último
array criado.
*/
recebeArray(arrayDiferente);
...
function book(nomeDoLivro) {
	...
	return !nomeDoLivro ? arrayDeLivros : arrayDeLivros[ nomeDoLivro ];
}
