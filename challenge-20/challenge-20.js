(function(win, doc) {
    ...
    */
    $button.addEventListener("click", function(event) {
        ...
        var confirmado = win.confirm("Tem certeza que deseja enviar o formulário?");

        confirmado ? win.alert("Enviado com sucesso!") : win.alert("Não enviado.");
    }, false);
    ...
    */
    function isValidEmail(email) {
        var regex = new RegExp("^[\\w/./+]+@[\\w]+.([a-z]{2,})(\\.[a-z]{2})?$");
