(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, "Otavio Correa Ferreira"));
    ...
    */
    ...
    console.log(text.replace(/(O Centauro de Luvas)/, function(total, palavra) {
    ...
    */
    ...
    console.log(text.replace(/ de (junho|julho) de /g, function(total, mes) {
    ...
    */
    ...
    console.log(text.match(/(\d\d) de (junho|julho) de (\d\d\d\d)/g)); 
    ...
    */
    ...
    console.log(text.replace(/(\d\d) de (junho|julho) de (\d\d\d\d)/g, replaceDate));
})();
