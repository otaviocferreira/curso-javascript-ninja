(function() {
    ...
    */
    ...
    var linguaDoP = name.reduce(function(completo, silaba) {
        return completo + "P" + silaba;
    }, "P");
    ...
    */
    ...
    var inverseName = name.reduceRight(function(completo, silaba) {
        return completo + silaba;
    });
    ...
    */
    ...
    console.log(numberObjects.indexOf === -1
        ? "Não existe um objeto { number: 2 } em numberObjects :("
        : "Existe um objeto { number: 2 } em numberObjects!");
    ...
    */
    ...
    console.log(numberObjects.indexOf(numberObjects.length-1) === -1
        ? "Não existe um objeto { number: 2 } em numberObjects :("
        : "Existe um objeto { number: 2 } em numberObjects!");
